# 2.1 编译过程 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#21-编译过程)
...
## 2.1.1 预备知识 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#211-预备知识)
...
### 抽象语法树 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#抽象语法树)
...
### 静态单赋值 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#静态单赋值)
...
### 指令集 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#指令集)
...
## 2.1.2 编译原理 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#212-编译原理)
...
![complication-process](https://raw.githubusercontent.com/yinhuiSpace/picgoimg/main/img/202409181944616.png)

**图 2-2 编译原理的核心过程**

Go 的编译器在逻辑上可以被分成四个阶段：词法与语法分析、类型检查和 AST 转换、通用 SSA 生成和最后的机器代码生成，在这一节我们会使用比较少的篇幅分别介绍这四个阶段做的工作，后面的章节会具体介绍每一个阶段的具体内容。

### 词法与语法分析 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#词法与语法分析)
...
### 类型检查 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#类型检查)
...
### 中间代码生成 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#中间代码生成)
...
### 机器码生成 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#机器码生成)
...
## 2.1.3 编译器入口 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-compile-intro/#213-编译器入口)
...
# 2.2 词法分析和语法分析 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#22-词法分析和语法分析)
...
## 2.2.1 词法分析 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#221-词法分析)
...
### lex [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#lex)
...
![simplego-lex](https://raw.githubusercontent.com/yinhuiSpace/picgoimg/main/img/202409182127958.png)
...
### Go [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#go)
...
## 2.2.2 语法分析 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#222-语法分析)
...
### 文法 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#文法)
...
文法被定义成一个四元组 $(N, \Sigma, P, S)$，这个元组中的几部分是上面提到的四个符号，其中最为重要的就是生产规则，每个生产规则都会包含非终结符、终结符或者开始符号，我们在这里可以举个简单的例子：
...
### 分析方法 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#分析方法)
...
#### 自顶向下 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#自顶向下)
...
这种分析方法一定会从开始符号分析，通过下一个即将入栈的符号判断应该如何对当前堆栈中最右侧的非终结符（$S$ 或 $S_1$）进行展开，直到整个字符串中不存在任何的非终结符，整个解析过程才会结束。

#### 自底向上 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#自底向上)
...
#### Lookahead [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#lookahead)
...
### Go [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#go-1)
...
![golang-parse](https://raw.githubusercontent.com/yinhuiSpace/picgoimg/main/img/202409182127481.png)
...
#### 辅助方法 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#辅助方法)
...
#### 节点 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-lexer-and-parser/#节点)
...
# 2.3 类型检查 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#23-类型检查)
...
## 2.3.1 强弱类型 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#231-强弱类型)
...
![strong-and-weak-typing](https://raw.githubusercontent.com/yinhuiSpace/picgoimg/main/img/202409182237522.png)
...
## 2.3.2 静态类型与动态类型 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#232-静态类型与动态类型)
...
### 静态类型检查 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#静态类型检查)
...
### 动态类型检查 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#动态类型检查)
...
## 2.3.3 执行过程 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#233-执行过程)
...
### 切片 OTARRAY [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#切片-otarray)
...
### 哈希 OTMAP [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#哈希-otmap)
...
### 关键字 OMAKE [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-typecheck/#关键字-omake)
...
# 2.4 中间代码生成 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-ir-ssa/#24-中间代码生成)
...
## 2.4.1 概述 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-ir-ssa/#241-概述)
...
## 2.4.2 配置初始化 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-ir-ssa/#242-配置初始化)
...
![golang-type-and-pointer](https://raw.githubusercontent.com/yinhuiSpace/picgoimg/main/img/202409182313111.png)
...
## 2.4.3 遍历和替换 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-ir-ssa/#243-遍历和替换)
...
![golang-keyword-and-builtin-mapping](https://raw.githubusercontent.com/yinhuiSpace/picgoimg/main/img/202409182313599.png)
...
## 2.4.4 SSA 生成 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-ir-ssa/#244-ssa-生成)
...
### AST 到 SSA [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-ir-ssa/#ast-到-ssa)
...
### 多轮转换 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-ir-ssa/#多轮转换)
...
# 2.5 机器码生成 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-machinecode/#25-机器码生成)
...
## 2.5.1 指令集架构 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-machinecode/#251-指令集架构)
...
![cisc-and-ris](https://raw.githubusercontent.com/yinhuiSpace/picgoimg/main/img/202409182320688.png)
...
## 2.5.2 机器码生成 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-machinecode/#252-机器码生成)
...
### SSA 降级 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-machinecode/#ssa-降级)
...
### 汇编器 [#](https://draveness.me/golang/docs/part1-prerequisite/ch02-compile/golang-machinecode/#汇编器)
